...
$sql="insert into contactus(fname,lname,msg)values('$fname','$lname','$msg')";
...
<form method="POST">
  ...
  <textarea id="message" name="msg" style="width: 100%; height: 150px; background-color: #257DC7; margin: 8px 0; box-sizing: border-box; border: none; border-bottom: 2px solid white;" required></textarea>
  <center>
   <input type="submit" name="save" value="Send your Message" style="width: 300px; background-color:white; ; color:#257DC7; padding: 14px 20px; margin: 20px 0; border: none; border-radius: 10px;">
   </center>
</form>
</div>
</div>
