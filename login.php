...
<div class="row">
<div class="col-xl-8">
<img src="simage/rt.jpg" class="img-fluid" style="margin-top:40px; border-radius:40px; box-shadow: -4px 4px 8px rgba(0, 0, 0, 0.9);">
</div>
<div class="col-xl-4">
<div style="height:631px; width:400px; border-radius: 5px; background-color:#257DC7; margin:40px 10% 0% 0px%; padding:20px;">

<img src="lg.png"><h1 style="text-align:center; color:white; margin-top:30px; ">Travel Vista</h1>
<form method="POST" style="margin:90px 0px 0px 0px;">
 <label for="email" style="color:white;">Email</label>
  <input type="text" id="email" name="email" style="width: 100%; padding: 12px 20px; background-color:#257DC7; margin: 8px 0; box-sizing: border-box; border: none; border-bottom: 2px solid white;" required>
  <label for="password" style="color:white;">password</label>
  <input type="password" id="password" name="password" style="width: 100%; padding: 12px 20px; background-color:#257DC7; margin: 8px 0; box-sizing: border-box; border: none; border-bottom: 2px solid white;" required>
  <a href="Login" style=" text-decoration:none; color:white;"><small>Forget your password?</small></a><br>
  <label style="color: white;">
  <input type="checkbox" name="remember" style="margin-right: 5px;">Remember Me
  </label>
  <center>
   
   <button type="save" name="save" class="btn btn-danger" style="width: 300px; background-color:white; ; color:#257DC7; padding: 14px 20px; margin: 20px 0; border: none; border-radius: 10px;">Submit</button>
   </center>
</form>
</div>
</div>
